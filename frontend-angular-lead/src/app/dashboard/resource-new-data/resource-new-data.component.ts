...
@Component({
  selector: 'app-resource-new-data',
  templateUrl: './resource-new-data.component.html',
  styleUrls: ['./resource-new-data.component.css']
})
export class ResourceNewDataComponent implements OnInit, AfterViewInit {
