...
export class LeadsComponent implements  OnInit, AfterViewInit{
 ...
 dtOptions: DataTables.Settings = {};
   ...
   constructor(private route: ActivatedRoute,
    ...
    this.dtOptions = {
      ...
      columns: [
        ...
        { title:'Schedulded Time', data:'scheduldedTime'},
  ...
  downloadtable():void {
    this.leadsService.performActionDownloadLeads().subscribe((resources) => {
  ...
  ngAfterViewInit(): void {
    ...
    this.renderer.listenGlobal('document', 'click', (event) => {
      if (event.target.hasAttribute("lead-edit-id")){
        this.router.navigate(["dashboard/leads/edit-leads/"+ event.target.getAttribute("lead-edit-id")], {queryParams:{app:"leads"}});
      }if(event.target.hasAttribute("lead-delete-id")) {
        this.router.navigate(["dashboard/leads/delete-leads/"+ event.target.getAttribute("lead-delete-id")], {queryParams:{app:"leads"}});
      }
    });
