! function(r) {
    ...
    e.prototype.respChart = function(e, a, t, o) {
        ...
        if (r("#revenue-chart").length > 0) {
         ...
         if (r("#high-performing-product-1").length > 0) {
            var a = document.getElementById("high-performing-product-1").getContext("2d").createLinearGradient(0, 500, 0, 150);
            ...
            e.push(this.respChart(r("#high-performing-product-1"), "Bar", t, {
                maintainAspectRatio: !1,
                legend: {
                    display: !1
                },
