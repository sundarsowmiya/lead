...
! function(e, t) {
    ...
    t.createBarChart = function(e, t) {
        var a = new britecharts.miniTooltip,
            l = new britecharts.bar,
            n = d3.select(e),
        ...
        var a = new britecharts.bar,
            l = d3.select(e),
            n = !!l.node() && l.node().getBoundingClientRect().width,
        ...
        var a = britecharts.donut(),
            l = britecharts.legend();
